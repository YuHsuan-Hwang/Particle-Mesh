...
double G = G_scaled;         // gravitational constant
double dt = 1.0e-2;      // time interval
int   N = 4 ;           // particle number
const int gridN = 256;       // # of grid
const int gridNk = 8;          // # of grid in Z direction
const int T = 300;
double L = 250;       // box size
...
void compute_rho(int N, int gridN , double dx, double* rho) {
...
{
    //int argc, char *argv[]
    m = { 40.0, 30.0 , 20.0 , 90.0 , 30.0 , 6.5};
    x = { 0.0, 40.0, -20.0 , -0.0, 4.2 };
